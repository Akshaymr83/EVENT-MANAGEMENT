...
//     try {
//       const response = await axios.post('http://localhost:5000/api/company/companySignup', formData);
...
//       </form>
//       {message && <p>{message}</p>}
//     <Link to={'/companyLogin'}><button type="submit">CompanyLogin</button></Link>  
//     </div>
//   );
// };
...
import { useNavigate } from 'react-router-dom';
import { Link } from 'react-router-dom';
import './ComSignup.css'; // Assuming you will place the styles in this CSS file.
  ...
  return (
   <div className='login'>
    <div className="form-container">
      <p className="title">Create Company account</p>
      ...
      <p className="sign-up-label">
        Already have an account? <Link to="/companyLogin" className="sign-up-link">Log in</Link>
      </p>
      <p className="sign-up-label">
         User account? <Link to="/signup" className="sign-up-link">Log in</Link>
      </p>
